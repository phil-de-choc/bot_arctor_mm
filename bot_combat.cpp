...
bot_weapon_select_t valve_weapon_select[] = {
   {VALVE_WEAPON_CROWBAR, "weapon_crowbar", 2, 0.0F, 50.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {VALVE_WEAPON_HANDGRENADE, "weapon_handgrenade", 5, 250.0F, 750.0F, 0.0F, 0.0F,
    30, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {VALVE_WEAPON_SNARK, "weapon_snark", 5, 150.0F, 500.0F, 0.0F, 0.0F,
    50, FALSE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {VALVE_WEAPON_EGON, "weapon_egon", 5, 0.0F, 9999.0F, 0.0F, 0.0F,
    100, FALSE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {VALVE_WEAPON_GAUSS, "weapon_gauss", 5, 0.0F, 9999.0F, 0.0F, 9999.0F,
    100, FALSE, 80, 1, 10, FALSE, FALSE, FALSE, TRUE, 0.0F, 0.8F},
   {VALVE_WEAPON_SHOTGUN, "weapon_shotgun", 5, 30.0F, 150.0F, 30.0F, 150.0F,
    100, FALSE, 70, 1, 2, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {VALVE_WEAPON_PYTHON, "weapon_357", 5, 30.0F, 700.0F, 0.0F, 0.0F,
    100, FALSE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {VALVE_WEAPON_HORNETGUN, "weapon_hornetgun", 5, 30.0F, 1000.0F, 30.0F, 1000.0F,
    100, TRUE, 50, 1, 4, FALSE, TRUE, FALSE, FALSE, 0.0F, 0.0F},
   {VALVE_WEAPON_MP5, "weapon_9mmAR", 5, 0.0F, 250.0F, 300.0F, 600.0F,
    100, FALSE, 90, 1, 1, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {VALVE_WEAPON_CROSSBOW, "weapon_crossbow", 5, 100.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {VALVE_WEAPON_RPG, "weapon_rpg", 5, 300.0F, 9999.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {VALVE_WEAPON_GLOCK, "weapon_9mmhandgun", 5, 0.0F, 1200.0F, 0.0F, 1200.0F,
...
bot_weapon_select_t tfc_weapon_select[] = {
   {TF_WEAPON_AXE, "tf_weapon_axe", 5, 0.0F, 50.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_KNIFE, "tf_weapon_knife", 5, 0.0F, 40.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_SPANNER, "tf_weapon_spanner", 5, 0.0F, 40.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_MEDIKIT, "tf_weapon_medikit", 5, 0.0F, 40.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_SNIPERRIFLE, "tf_weapon_sniperrifle", 5, 300.0F, 9999.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, TRUE, FALSE, 1.0F, 0.0F},
   {TF_WEAPON_FLAMETHROWER, "tf_weapon_flamethrower", 5, 100.0F, 500.0F, 0.0F, 0.0F,
    100, FALSE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_AC, "tf_weapon_ac", 5, 50.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_GL, "tf_weapon_gl", 5, 300.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_RPG, "tf_weapon_rpg", 5, 300.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_IC, "tf_weapon_ic", 5, 300.0F, 800.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_TRANQ, "tf_weapon_tranq", 5, 40.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_RAILGUN, "tf_weapon_railgun", 5, 40.0F, 800.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_SUPERNAILGUN, "tf_weapon_superng", 5, 40.0F, 800.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_SUPERSHOTGUN, "tf_weapon_supershotgun", 5, 40.0F, 500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 2, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_AUTORIFLE, "tf_weapon_autorifle", 5, 0.0F, 800.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_SHOTGUN, "tf_weapon_shotgun", 5, 40.0F, 400.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {TF_WEAPON_NAILGUN, "tf_weapon_ng", 5, 40.0F, 600.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   /* terminator */
   {0, "", 0, 0.0F, 0.0F, 0.0F, 0.0F, 0, TRUE, 0, 1, 1, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F}
};
...
bot_weapon_select_t cs_weapon_select[] = {
   {CS_WEAPON_KNIFE, "weapon_knife", 5, 0.0F, 50.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_M4A1, "weapon_m4a1", 5, 0.0F, 1500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_SG552, "weapon_sg552", 5, 0.0F, 1200.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_P90, "weapon_p90", 5, 0.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_MP5NAVY, "weapon_mp5navy", 5, 0.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_AK47, "weapon_ak47", 5, 0.0F, 1500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_AUG, "weapon_aug", 5, 0.0F, 1500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_MAC10, "weapon_mac10", 5, 0.0F, 600.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_UMP45, "weapon_ump45", 5, 0.0F, 800.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_XM1014, "weapon_xm1014", 5, 0.0F, 400.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_AWP, "weapon_awp", 5, 0.0F, 3500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_G3SG1, "weapon_g3sg1", 5, 0.0F, 3500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_M249, "weapon_m249", 5, 0.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_M3, "weapon_m3", 5, 0.0F, 500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_TMP, "weapon_tmp", 5, 0.0F, 800.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_SCOUT, "weapon_scout", 5, 0.0F, 3500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_DEAGLE, "weapon_deagle", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_USP, "weapon_usp", 5, 0.0F, 1200.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_P228, "weapon_p228", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_GLOCK18, "weapon_glock18", 5, 0.0F, 1200.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_ELITE, "weapon_usp", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {CS_WEAPON_FIVESEVEN, "weapon_fiveseven", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   /* terminator */
   {0, "", 0, 0.0F, 0.0F, 0.0F, 0.0F, 0, TRUE, 0, 1, 1, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F}
};
...
bot_weapon_select_t gearbox_weapon_select[] = {
   {GEARBOX_WEAPON_PIPEWRENCH, "weapon_pipewrench", 3, 0.0F, 50.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_KNIFE, "weapon_knife", 4, 0.0F, 50.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_CROWBAR, "weapon_crowbar", 2, 0.0F, 50.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_DISPLACER, "weapon_displacer", 5, 100.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_SPORELAUNCHER, "weapon_sporelauncher", 5, 500.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_SHOCKRIFLE, "weapon_shockrifle", 5, 50.0F, 800.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_SNIPERRIFLE, "weapon_sniperrifle", 5, 50.0F, 2500.0F, 0.0F, 0.0F,
    100, FALSE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_HANDGRENADE, "weapon_handgrenade", 5, 250.0F, 750.0F, 0.0F, 0.0F,
    30, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_SNARK, "weapon_snark", 5, 150.0F, 500.0F, 0.0F, 0.0F,
    50, FALSE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_EGON, "weapon_egon", 5, 0.0F, 9999.0F, 0.0F, 0.0F,
    100, FALSE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_GAUSS, "weapon_gauss", 5, 0.0F, 9999.0F, 0.0F, 9999.0F,
    100, FALSE, 80, 1, 10, FALSE, FALSE, FALSE, TRUE, 0.0F, 0.8F},
   {GEARBOX_WEAPON_M249, "weapon_m249", 5, 0.0F, 400.0F, 0.0F, 0.0F,
    100, FALSE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_SHOTGUN, "weapon_shotgun", 5, 30.0F, 150.0F, 30.0F, 150.0F,
    100, FALSE, 70, 1, 2, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_EAGLE, "weapon_eagle", 5, 0.0F, 1200.0F, 0.0F, 0.0F,
    100, FALSE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_PYTHON, "weapon_357", 5, 30.0F, 700.0F, 0.0F, 0.0F,
    100, FALSE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_HORNETGUN, "weapon_hornetgun", 5, 30.0F, 1000.0F, 30.0F, 1000.0F,
    100, TRUE, 50, 1, 4, FALSE, TRUE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_MP5, "weapon_9mmAR", 5, 0.0F, 250.0F, 300.0F, 600.0F,
    100, FALSE, 90, 1, 1, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_CROSSBOW, "weapon_crossbow", 5, 100.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_RPG, "weapon_rpg", 5, 300.0F, 9999.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {GEARBOX_WEAPON_GLOCK, "weapon_9mmhandgun", 5, 0.0F, 1200.0F, 0.0F, 1200.0F,
    100, TRUE, 70, 1, 1, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   /* terminator */
   {0, "", 0, 0.0F, 0.0F, 0.0F, 0.0F, 0, TRUE, 0, 1, 1, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F}
};
...
bot_weapon_select_t frontline_weapon_select[] = {
   {FLF_WEAPON_HEGRENADE, "weapon_hegrenade", 3, 200.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_FLASHBANG, "weapon_flashbang", 3, 100.0F, 800.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
//   {FLF_WEAPON_KNIFE, "weapon_knife", 3, 0.0F, 60.0F, 0.0F, 0.0F,
//    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_HK21, "weapon_hk21", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_UMP45, "weapon_ump45", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_FAMAS, "weapon_famas", 5, 0.0F, 500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_MSG90, "weapon_msg90", 5, 0.0F, 2500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_SAKO, "weapon_sako", 5, 0.0F, 1800.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_MP5A2, "weapon_mp5a2", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_AK5, "weapon_ak5", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_RS202M2, "weapon_rs202m2", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_MP5SD, "weapon_mp5sd", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_M4, "weapon_m4", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_SPAS12, "weapon_spas12", 5, 0.0F, 900.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_MAC10, "weapon_mac10", 5, 0.0F, 500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_BERETTA, "weapon_beretta", 5, 0.0F, 1200.0F, 0.0F, 1200.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {FLF_WEAPON_MK23, "weapon_mk23", 5, 0.0F, 1200.0F, 0.0F, 1200.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   /* terminator */
   {0, "", 0, 0.0F, 0.0F, 0.0F, 0.0F, 0, TRUE, 0, 1, 1, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F}
};
...
bot_weapon_select_t holywars_weapon_select[] = {
   {HW_WEAPON_JACKHAMMER, "weapon_jackhammer", 5, 0.0F, 50.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {HW_WEAPON_MACHINEGUN, "weapon_machinegun", 5, 50.0F, 1500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {HW_WEAPON_RAILGUN, "weapon_railgun", 5, 50.0F, 9999.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {HW_WEAPON_DOUBLESHOTGUN, "weapon_doubleshotgun", 5, 50.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 3, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {HW_WEAPON_ROCKETLAUNCHER, "weapon_rocketlauncher", 5, 50.0F, 1500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   /* terminator */
   {0, "", 0, 0.0F, 0.0F, 0.0F, 0.0F, 0, TRUE, 0, 1, 1, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F}
};
...
bot_weapon_select_t dmc_weapon_select[] = {
   {DMC_WEAPON_AXE, "weapon_axe", 2, 0.0F, 50.0F, 0.0F, 0.0F,
    100, TRUE, 100, 0, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {DMC_WEAPON_LIGHTNING, "weapon_lightning", 5, 30.0F, 1500.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {DMC_WEAPON_ROCKET1, "weapon_rocket1", 5, 150.0F, 1000.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {DMC_WEAPON_SUPERNAIL, "weapon_supernail", 5, 50.0F, 400.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {DMC_WEAPON_DOUBLESHOTGUN, "weapon_doubleshotgun", 5, 50.0F, 250.0F, 0.0F, 0.0F,
    100, TRUE, 100, 2, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {DMC_WEAPON_GRENADE1, "weapon_grenade1", 5, 200.0F, 800.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {DMC_WEAPON_NAILGUN, "weapon_nailgun", 5, 50.0F, 400.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, TRUE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   {DMC_WEAPON_SHOTGUN, "weapon_shotgun", 5, 0.0F, 250.0F, 0.0F, 0.0F,
    100, TRUE, 100, 1, 0, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F},
   /* terminator */
   {0, "", 0, 0.0F, 0.0F, 0.0F, 0.0F, 0, TRUE, 0, 1, 1, FALSE, FALSE, FALSE, FALSE, 0.0F, 0.0F}
};
...
bot_fire_delay_t valve_fire_delay[] = {
   {VALVE_WEAPON_CROWBAR,
    0.3F, {0.0F, 0.2F, 0.3F, 0.4F, 0.6F}, {0.1F, 0.3F, 0.5F, 0.7F, 1.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {VALVE_WEAPON_HANDGRENADE,
    0.1F, {1.0F, 2.0F, 3.0F, 4.0F, 5.0F}, {3.0F, 4.0F, 5.0F, 6.0F, 7.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {VALVE_WEAPON_SNARK,
    0.1F, {0.0F, 0.1F, 0.2F, 0.4F, 0.6F}, {0.1F, 0.2F, 0.5F, 0.7F, 1.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {VALVE_WEAPON_EGON,
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {VALVE_WEAPON_GAUSS,
    0.2F, {0.0F, 0.2F, 0.3F, 0.5F, 1.0F}, {0.1F, 0.3F, 0.5F, 0.8F, 1.2F},
    1.0F, {0.2F, 0.3F, 0.5F, 0.8F, 1.2F}, {0.5F, 0.7F, 1.0F, 1.5F, 2.0F}},
   {VALVE_WEAPON_SHOTGUN,
    0.75F, {0.0F, 0.2F, 0.4F, 0.6F, 0.8F}, {0.25F, 0.5F, 0.8F, 1.2F, 2.0F},
    1.5F, {0.0F, 0.2F, 0.4F, 0.6F, 0.8F}, {0.25F, 0.5F, 0.8F, 1.2F, 2.0F}},
   {VALVE_WEAPON_PYTHON,
    0.75F, {0.0F, 0.2F, 0.4F, 1.0F, 1.5F}, {0.25F, 0.5F, 0.8F, 1.3F, 2.2F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {VALVE_WEAPON_HORNETGUN,
    0.25F, {0.0F, 0.25F, 0.4F, 0.6F, 1.0F}, {0.1F, 0.4F, 0.7F, 1.0F, 1.5F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {VALVE_WEAPON_MP5,
    0.1F, {0.0F, 0.1F, 0.25F, 0.4F, 0.5F}, {0.1F, 0.3F, 0.45F, 0.65F, 0.8F},
    1.0F, {0.0F, 0.4F, 0.7F, 1.0F, 1.4F}, {0.3F, 0.7F, 1.0F, 1.6F, 2.0F}},
   {VALVE_WEAPON_CROSSBOW,
    0.75F, {0.0F, 0.2F, 0.5F, 0.8F, 1.0F}, {0.25F, 0.4F, 0.7F, 1.0F, 1.3F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {VALVE_WEAPON_RPG,
    1.5F, {1.0F, 2.0F, 3.0F, 4.0F, 5.0F}, {3.0F, 4.0F, 5.0F, 6.0F, 7.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {VALVE_WEAPON_GLOCK,
    0.3F, {0.0F, 0.1F, 0.2F, 0.3F, 0.4F}, {0.1F, 0.2F, 0.3F, 0.4F, 0.5F},
    0.2F, {0.0F, 0.0F, 0.1F, 0.1F, 0.2F}, {0.1F, 0.1F, 0.2F, 0.2F, 0.4F}},
   /* terminator */
...
bot_fire_delay_t tfc_fire_delay[] = {
   ...
   {TF_WEAPON_AC,
    ...
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {TF_WEAPON_GL,
    0.6F, {0.0F, 0.2F, 0.5F, 0.8F, 1.0F}, {0.25F, 0.4F, 0.7F, 1.0F, 1.3F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {TF_WEAPON_RPG,
    0.5F, {0.0F, 0.1F, 0.3F, 0.6F, 1.0F}, {0.1F, 0.2F, 0.7F, 1.0F, 2.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {TF_WEAPON_IC,
    2.0F, {1.0F, 2.0F, 3.0F, 4.0F, 5.0F}, {3.0F, 4.0F, 5.0F, 6.0F, 7.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {TF_WEAPON_TRANQ,
    1.5F, {1.0F, 2.0F, 3.0F, 4.0F, 5.0F}, {3.0F, 4.0F, 5.0F, 6.0F, 7.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {TF_WEAPON_RAILGUN,
    0.4F, {0.0F, 0.1F, 0.2F, 0.3F, 0.4F}, {0.1F, 0.2F, 0.3F, 0.4F, 0.5F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   ...
   {TF_WEAPON_AUTORIFLE,
    ...
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {TF_WEAPON_SHOTGUN,
    0.5F, {0.0F, 0.2F, 0.4F, 0.6F, 0.8F}, {0.25F, 0.5F, 0.8F, 1.2F, 2.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {TF_WEAPON_NAILGUN,
    0.1F, {0.0F, 0.1F, 0.2F, 0.4F, 0.6F}, {0.1F, 0.2F, 0.5F, 0.7F, 1.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
...
bot_fire_delay_t gearbox_fire_delay[] = {
   {GEARBOX_WEAPON_PIPEWRENCH,
    0.5F, {0.0F, 0.2F, 0.3F, 0.4F, 0.6F}, {0.1F, 0.3F, 0.5F, 0.7F, 1.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {GEARBOX_WEAPON_KNIFE,
    0.4F, {0.0F, 0.2F, 0.3F, 0.4F, 0.6F}, {0.1F, 0.3F, 0.5F, 0.7F, 1.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {GEARBOX_WEAPON_CROWBAR,
    0.3F, {0.0F, 0.2F, 0.3F, 0.4F, 0.6F}, {0.1F, 0.3F, 0.5F, 0.7F, 1.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {GEARBOX_WEAPON_DISPLACER,
    5.0F, {0.0F, 0.5F, 0.8F, 1.6F, 2.5F}, {0.3F, 0.8F, 1.4F, 2.2F, 3.5F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {GEARBOX_WEAPON_SPORELAUNCHER,
    0.5F, {0.0F, 0.2F, 0.3F, 0.4F, 0.6F}, {0.1F, 0.3F, 0.5F, 0.7F, 1.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {GEARBOX_WEAPON_SHOCKRIFLE,
    0.1F, {0.0F, 0.1F, 0.2F, 0.3F, 0.4F}, {0.1F, 0.2F, 0.3F, 0.4F, 0.5F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   ...
   {GEARBOX_WEAPON_EAGLE,
    0.25F, {0.0F, 0.1F, 0.2F, 0.3F, 0.5F}, {0.1F, 0.25F, 0.4F, 0.7F, 1.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
...
//    0.2F, {0.0F, 0.0F, 0.1F, 0.1F, 0.2F}, {0.1F, 0.1F, 0.2F, 0.2F, 0.4F}},
   ...
   {FLF_WEAPON_FAMAS,
    ...
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {FLF_WEAPON_MSG90,
    1.2F, {0.0F, 0.1F, 0.2F, 0.3F, 0.4F}, {0.1F, 0.2F, 0.3F, 0.4F, 0.5F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {FLF_WEAPON_SAKO,
    2.0F, {0.0F, 0.1F, 0.2F, 0.3F, 0.4F}, {0.1F, 0.2F, 0.3F, 0.4F, 0.5F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {FLF_WEAPON_MP5A2,
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   ...
   {FLF_WEAPON_M4,
    ...
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {FLF_WEAPON_SPAS12,
    0.9F, {0.0F, 0.1F, 0.2F, 0.3F, 0.4F}, {0.1F, 0.2F, 0.3F, 0.4F, 0.5F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {FLF_WEAPON_MAC10,
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
...
bot_fire_delay_t holywars_fire_delay[] = {
   ...
   {HW_WEAPON_MACHINEGUN,
    ...
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {HW_WEAPON_RAILGUN,
    0.9F, {0.0F, 0.1F, 0.2F, 0.3F, 0.4F}, {0.1F, 0.2F, 0.3F, 0.5F, 0.7F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {HW_WEAPON_DOUBLESHOTGUN,
    2.1F, {0.0F, 0.1F, 0.2F, 0.3F, 0.4F}, {0.1F, 0.2F, 0.3F, 0.5F, 0.7F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {HW_WEAPON_ROCKETLAUNCHER,
    1.0F, {0.0F, 0.1F, 0.2F, 0.3F, 0.4F}, {0.1F, 0.2F, 0.3F, 0.5F, 0.7F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   /* terminator */
   {0, 0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F},
       0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}}
...
bot_fire_delay_t dmc_fire_delay[] = {
   ...
   {DMC_WEAPON_LIGHTNING,
    ...
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {DMC_WEAPON_ROCKET1,
    0.8F, {0.0F, 0.2F, 0.3F, 0.4F, 0.6F}, {0.1F, 0.3F, 0.5F, 0.7F, 1.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {DMC_WEAPON_SUPERNAIL,
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {DMC_WEAPON_DOUBLESHOTGUN,
    0.7F, {0.0F, 0.1F, 0.1F, 0.2F, 0.3F}, {0.1F, 0.2F, 0.3F, 0.5F, 0.7F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {DMC_WEAPON_GRENADE1,
    0.6F, {0.0F, 0.1F, 0.2F, 0.3F, 0.4F}, {0.1F, 0.2F, 0.3F, 0.5F, 0.7F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
   {DMC_WEAPON_NAILGUN,
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F},
    0.0F, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F}},
